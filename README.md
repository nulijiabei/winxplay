 ...
 ***1. 下载程序***
 ...
 ```
 git clone https://github.com/nulijiabei/winxplay.git -b v1.0.19.v20200814 # (最新发布版请查看标签)
 或 
 git clone https://gitee.com/nljb/winxplay.git -b v1.0.19.v20200814 # (最新发布版请查看标签)
 ```
...
winxplay/xplayctl.exe -change -zIndex 10 -newIndex 11 # 改变层(切换层)
