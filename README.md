 ...
 ***1. 下载程序***
 ...
 ```
 git clone https://github.com/nulijiabei/winxplay.git -b v1.0.17.v20200522 # (最新发布版请查看标签)
 或 
 git clone https://gitee.com/nljb/winxplay.git -b v1.0.17.v20200522 # (最新发布版请查看标签)
 ```
